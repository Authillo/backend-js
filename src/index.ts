...
class authillo {
  ...
  private _initializationIsValid() {
    return (
      this.clientId != null && this.clientSecret != null && this.jwtKey != null
    );
  }
  ...
  public tokenRequest = async (
    ...
    if (code_verifier == null) {
      ...
      code_verifier =
        this._getUnsafeCodeChallengeAndCodeVerifierPair().unsafeCodeVerifier;
    }
    ...
    try {
      ...
      return {
        result: {
          succeeded: false,
          feedback: { customCode: TOKEN_ERROR_CODES.INVALID_ID_TOKEN },
        },
      };
    }
  };
